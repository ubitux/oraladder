...
~/venv/bin/ora-ladder -d db-ladder-all.sqlite3      /home/ora/srv-ladder/instance-*/support_dir/Replays/
...
cp db-ladder-all.sqlite3 /home/web/venv/var/ladderweb-instance/db-all.sqlite3
